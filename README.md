# OVARIANSIGNATURE — сайт научного проекта

Понятная одностраничная презентация заявки «ВЫЗОВ» / «Перспектива»: полное описание методологии молекулярных сигнатур на модели **HGSC** (ИБМХ · Авогадро).
